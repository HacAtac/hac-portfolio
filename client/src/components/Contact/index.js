...
function ContactForm() {
  ...
  //handleSubmit function that sends the form data to the server and then sends the user to a new page that says "Thank you for contacting me!"

  return (
    //to get the post request to work, you need to add a form to the page and then add a submit button to the form. on the submit button, you need to add a function that sends the form data to the server and then sends the user to a new page that says "Thank you for contacting me!"
    <div className=''>
